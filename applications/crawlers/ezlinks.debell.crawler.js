...
const options = { 
    method: 'POST',
    url: 'https://debell.ezlinksgolf.com/api/search/search',
    headers: 
     { 
       'cache-control': 'no-cache',
       'accept-language': 'en-US,en;q=0.9,he;q=0.8',
       'accept-encoding': 'gzip, deflate, br',
       referer: 'https://debell.ezlinksgolf.com/index.html',
       'sec-fetch-dest': 'empty',
       'sec-fetch-mode': 'cors',
       'sec-fetch-site': 'same-origin',
       origin: 'https://debell.ezlinksgolf.com',
